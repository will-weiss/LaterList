 ...
 *                             begin searching for searchElement; defaults to 0.
 * @lends  {LaterList.prototype}
 * @return {Promise<Boolean>} Whether the value appears in the list.
 */
exports.includes = function(toMatch, /* fromIndex */) {
 ...
 */
exports.splice = function(begin, deleteCount, /* additions */) {
